...
@Component({
  selector: 'app-forgot-org-password',
  standalone: true,
  imports: [NgStyle, FormsModule],
  templateUrl: './forgot-org-password.component.html',
  styleUrl: './forgot-org-password.component.css'
})
export class ForgotOrgPasswordComponent {
  email: string = '';
  ...
  forgetPassword(): void {
    ...
    this.http.post('http://localhost:3000/org/forgetorgpassword', { email: this.email })
    .subscribe(
      (response) => {
